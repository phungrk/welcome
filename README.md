...
4. Create `projects`folder for projects's source:  `mkdir projects` . Then [choose projects folder as the default to clone new project](https://github.com/riv-dev/git/wiki/Setting#general-setting)
